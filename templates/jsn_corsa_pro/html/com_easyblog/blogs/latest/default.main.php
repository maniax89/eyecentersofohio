...
<div itemprop="blogPosts" itemscope itemtype="http://schema.org/BlogPosting" class="eb-post" data-blog-posts-item data-id="<?php echo $post->id;?>">
		...
		<div class="eb-post-side <?php echo !$this->config->get('layout_avatar') || !$this->params->get('post_author_avatar', true) ? ' no-avatar' : '';?>">
			...
			<?php if ($this->config->get('main_comment') && $this->params->get('post_comment_counter', true) && $post->allowcomment) { ?>
				<div class="eb-post-comments">
					...
					<a href="<?php echo $post->getPermalink();?>"><?php echo $post->getTotalComments(); ?></a>
				</div>
			<?php } ?>

			<?php if ($this->params->get('post_type', true)) { ?>
			<div class="eb-post-type hide">
	...
	<div class="eb-post-content">
		<div class="eb-post-head">
			...
			<?php if ($this->params->get('post_date', true) || $this->params->get('post_author', true) || $this->params->get('post_category', true) || ($this->config->get('main_comment') && $this->params->get('post_comment_counter', true) && $post->allowcomment) || $this->params->get('post_hits', true) || $post->isFeatured ) { ?>
