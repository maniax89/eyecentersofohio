			...
			<div class="es-header flex flex-layout es-panel space-between">
				<div class="header-left flex">
					<div class="es-branding flex">
						...
						<svg version="1.1" width="60" height="60" style="margin: -10px 0; ">
							<style>
								#logo {
									/*transformb*/
							...
							<g class="container" style="transform: translate(0px,-5px) scale(0.8);">
								<g class="g1">
									<path class="l1" style="transform: rotateX(-55deg) rotateZ(-45deg);" d="M10 10 L60 10 L60 20 L25 20 L25 30 L60 30 L60 40 L25 40 L25 50 L60 50 L60 60 L10 60 Z"></path></g>
								<g class="g2" style="transform: translateY(12px);">
									<path class="l2" style="transform: rotateX(-55deg) rotateZ(-45deg);" d="M10 10 L20 10 L20 50 L60 50 L60 60 L10 60 Z"></path></g>
								<g class="g3" style="transform: translateY(24px);">
									<path class="l3" style="transform: rotateX(-55deg) rotateZ(-45deg);" d="M10 10 L20 10 L20 50 L60 50 L60 60 L10 60 Z"></path></g>
							</g>
						</svg>
...
<!--						<a class="btn btn-default add-btn add-video-btn"><span class="es-icon-icon-video"></span> </a>-->
				...
				<div class="header-right">
                    <select type="checkbox" data-bind="theme" class="btn-group jsn-es-select-theme">
                        <option value="dark"><?php echo JText::_('JSN_EASYSLIDER_PANEL_THEME_DARK');?></option>
                        <option value="light"><?php echo JText::_('JSN_EASYSLIDER_PANEL_THEME_LIGHT');?></option>
                    </select>
					<div class="btn-group">
...
<!--									<span class="fa fa-plus"></span>-->
				...
				<div class="es-sidebar flex flex-column space-around">
					...
					<div></div>
                    <div class="btn-group btn-group-vertical">
                        <a class="es-tooltip btn btn-default open-random-animation-panel" title="<?php echo JText::_('JSN_EASYSLIDER_RANDOM_ANIMATION', true);?>">
