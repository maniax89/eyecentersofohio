            ...
            if (current_id) {
                ...
                if ($(this).hasClass('tinymce'))
                {
                    ...
                    tinymce.init({
                        ...
                        entity_encoding : "raw",
                        valid_elements : typeof settings.plg_editor_tinymce != 'undefined' ? settings.plg_editor_tinymce.tinyMCE['default'].valid_elements : '',
                        extended_valid_elements : typeof settings.plg_editor_tinymce != 'undefined' ? settings.plg_editor_tinymce.tinyMCE['default'].extended_valid_elements : 'iframe|hr[id|title|alt|class|width|size|noshade]',
                ...
                else if ($(this).hasClass('jce'))
                {
                    ...
                    if(version == "new")
                    {
                        $('textarea').each(function(el,i) {
                            var editor = WFEditor._getEditor(el);
                            if(editor)
                            {
                                editor.destroy();
                            }
