	...
	$.fn.prettyPhoto = function(pp_settings) {
		...
		*/
		$.prettyPhoto.initialize = function() {
			...
			//pp_caption_csses = (isSet) ? jsnThemeGridjQuery.map(matchedObjects, function(n, i){ if($(n).attr(settings.hook).indexOf(theRel) != -1) return $(n).attr('caption_css'); }) : $.makeArray($(this).attr('caption_css'));
            //pp_description_csses = (isSet) ? jsnThemeGridjQuery.map(matchedObjects, function(n, i){ if($(n).attr(settings.hook).indexOf(theRel) != -1) return $(n).attr('description_css'); }) : $.makeArray($(this).attr('description_css'));
		...
		*/
		$.prettyPhoto.open = function(event) {
			...
			$pp_pic_holder.fadeIn(function(){
				...
				//Custom style
				//if(pp_caption_csses[set_position] != "" && typeof pp_caption_csses[set_position] != "undefined")
				//{
				//	$ppt.attr('style', pp_caption_csses[set_position]);
				//}

              // if(pp_description_csses[set_position] != "" && typeof pp_description_csses[set_position] != "undefined")
				//{
				//	$('.pp_description').attr('style',  $('.pp_description').attr('style')+';'+pp_description_csses[set_position])
				//}
